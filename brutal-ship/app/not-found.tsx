    ...
    return (
        <main className="min-h-screen bg-background-light flex items-center justify-center px-4">
            <div className="text-center max-w-lg">
                <div className="bg-accent-yellow border-4 border-black p-3 inline-block transform -rotate-3 shadow-neobrutalism-lg mb-8">
                ...
                <p className="text-lg text-ink-black/70 mb-8">
                    La página que buscás no existe o fue movida. Pero no te preocupes,
                    podés volver al inicio y explorar nuestros servicios.
                </p>
                <a
                    href={SITE_URL}
                    className="inline-flex items-center gap-2 bg-primary text-white border-2 border-black font-bold text-lg py-3 px-8 shadow-neobrutalism hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all rounded-lg"
                >
