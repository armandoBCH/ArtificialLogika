...
export default function LogikaLogo({ size = 44, className = "" }: LogikaLogoProps) {
    return (
        <svg
            viewBox="0 0 100 100"
            fill="none"
        ...
        >
            ...
            {/* Top (Violet) Patch para continuidad infinita */}
            <rect x="14" y="14" width="62" height="22" rx="6" fill="#8523E1" stroke="#1A1A1A" strokeWidth="4" clipPath="url(#woven-clip-v5)" />
        </svg>
    );
}
